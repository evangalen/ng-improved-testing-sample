# ngImprovedTesting sample &nbsp;[![Travis build status](https://travis-ci.org/evangalen/ng-improved-testing-sample.png?branch=master)](https://travis-ci.org/evangalen/ng-improved-testing-sample)
